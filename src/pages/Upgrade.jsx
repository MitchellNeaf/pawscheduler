...
const PLANS = [
  {
    ...
    features: [
      ...
      "Schedule — list, grid & month views",
      "Confirmed / paid / no-show tracking",
      "Check in / check out",
      "Grooming waivers (digital signature)",
      "Email reminders — first 25 appointments/month",
      "Dark mode",
    ],
    excluded: [
      "Unlimited reminders",
  ...
  },
  {
    ...
    name:        "Basic",
    price:       19.99,
    description: "Unlimited scheduling with automated email reminders.",
    color:       "blue",
    features: [
      "Everything in Free",
      "Unlimited appointments",
      "Unlimited email reminders & confirmations",
      "Editable services & pricing",
      "Add-ons & fees",
      "Pet photos",
      "48hr confirmation requests (email)",
  ...
  },
  {
    ...
    name:        "Growth",
    price:       49.99,
    description: "Dedicated number + full client management.",
    color:       "emerald",
    badge:       "Most Popular",
    features: [
      "Everything in Basic",
      ...
      "Two-way SMS inbox",
      "Grooming report cards (before/after photos, mood tags & notes)",
